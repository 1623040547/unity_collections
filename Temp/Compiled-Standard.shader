    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_11.xy = half2(fma((-u_xlat0.xx), float2(0.699999988, 0.0799999982), float2(1.70000005, 0.600000024)));
    ...
    u_xlat16_6.xyz = fma(FGlobals._Color.xyz, u_xlat16_5.xyz, half3(-0.0399999991, -0.0399999991, -0.0399999991));
    ...
    u_xlat14.x = dot(float3(FGlobals._WorldSpaceLightPos0.xyz), u_xlat2.xyz);
    ...
    u_xlat7.y = fma(u_xlat14.y, u_xlat14.x, 1.00001001);
...
Constant Buffer "FGlobals" (80 bytes) on slot 0 {
  ...
  VectorHalf4 _EmissionColor at 72
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat0.x = u_xlat0.x * 4.0;
    u_xlat16_3 = half(u_xlat25 * u_xlat0.y);
    ...
    u_xlat16_13.xyz = half3(u_xlat4.xyz * float3(u_xlat16_5.xxx));
    ...
    u_xlat16_13.xyz = half3(fma(u_xlat2.xyz, (-float3(u_xlat16_13.xxx)), u_xlat1.xyz));
    ...
    u_xlat16_3 = fma((-u_xlat16_3), u_xlat16_6.y, half(1.0));
...
Constant Buffer "FGlobals" (432 bytes) on slot 0 {
  ...
  VectorHalf4 _EmissionColor at 424
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_4.xyz = fma(FGlobals._Color.xyz, u_xlat16_7.xyz, half3(-0.0399999991, -0.0399999991, -0.0399999991));
    ...
    u_xlat0.xyz = fma(u_xlat7.xyz, float3(u_xlat16_25), u_xlat5.xyz);
    ...
    u_xlat16_25 = half(u_xlat22 * float(u_xlat16_6.x));
    u_xlat16_23 = fma((-u_xlat16_23), u_xlat16_6.y, half(1.0));
    u_xlat16_25 = u_xlat16_25 * half(6.0);
    u_xlat16_3 = unity_SpecCube0.sample(samplerunity_SpecCube0, float3(u_xlat16_2.xyz), level(float(u_xlat16_25)));
...
Constant Buffer "FGlobals" (448 bytes) on slot 0 {
  ...
  VectorHalf4 _EmissionColor at 440
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat0.x = u_xlat0.x * u_xlat24;
    u_xlat0.x = u_xlat0.x * 4.0;
    u_xlat16_26 = half(u_xlat25 * u_xlat0.y);
    u_xlat0.x = u_xlat0.z / u_xlat0.x;
    u_xlat0.x = u_xlat0.x + -9.99999975e-05;
    u_xlat0.x = max(u_xlat0.x, 0.0);
    u_xlat0.x = min(u_xlat0.x, 100.0);
...
Constant Buffer "FGlobals" (56 bytes) on slot 0 {
  VectorHalf4 _WorldSpaceLightPos0 at 0
  VectorHalf4 unity_SpecCube0_HDR at 8
  VectorHalf4 _LightColor0 at 16
  VectorHalf4 _Color at 24
  ...
  Float _Glossiness at 36
  ScalarHalf _OcclusionStrength at 40
  VectorHalf4 _EmissionColor at 48
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat0.x = min(u_xlat0.x, 100.0);
    u_xlat16_1.xyz = _MainTex.sample(sampler_MainTex, input.TEXCOORD0.xy).xyz;
    u_xlat16_4.xyz = fma(FGlobals._Color.xyz, u_xlat16_1.xyz, half3(-0.0399999991, -0.0399999991, -0.0399999991));
    u_xlat1.xyz = float3(u_xlat16_1.xyz) * float3(FGlobals._Color.xyz);
    u_xlat16_4.xyz = fma(half3(FGlobals._Metallic), u_xlat16_4.xyz, half3(0.0399999991, 0.0399999991, 0.0399999991));
...
Constant Buffer "FGlobals" (464 bytes) on slot 0 {
  ...
  Vector3 _WorldSpaceCameraPos at 0
  Vector4 _LightShadowData at 272
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat0.x = dot(u_xlat0.xyz, u_xlat5.xyz);
    u_xlat0.x = clamp(u_xlat0.x, 0.0f, 1.0f);
    u_xlat0.y = dot(u_xlat4.xyz, u_xlat5.xyz);
    u_xlat0.y = clamp(u_xlat0.y, 0.0f, 1.0f);
    u_xlat16 = (-FGlobals._Glossiness) + 1.0;
    u_xlat25 = u_xlat16 * u_xlat16;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat25 = dot(u_xlat3.xyz, u_xlat3.xyz);
    u_xlat25 = _LightTextureB0.sample(sampler_LightTextureB0, float2(u_xlat25)).x;
    u_xlat4.x = _LightTexture0.sample(sampler_LightTexture0, u_xlat3.xyz).w;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_4.xyz = fma(FGlobals._Color.xyz, u_xlat16_0.xyz, half3(-0.0399999991, -0.0399999991, -0.0399999991));
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat8 = float(u_xlat16_27) * float(u_xlat16_27);
    u_xlat8 = float(u_xlat16_27) * u_xlat8;
    u_xlat8 = float(u_xlat16_27) * u_xlat8;
    u_xlat16_27 = fma((-FGlobals._Metallic), half(0.959999979), half(0.959999979));
    ...
    u_xlat16_6.xyz = half3(fma(u_xlat2.xyz, float3(u_xlat16_27), float3(u_xlat16_6.xyz)));
    ...
    Mtl_VertexIn input [[ stage_in ]])
{
    ...
    output.TEXCOORD5.xyz = max(u_xlat16_2.xyz, half3(0.0, 0.0, 0.0));
    output.TEXCOORD5.w = half(0.0);
    output.TEXCOORD7 = float4(0.0, 0.0, 0.0, 0.0);
    return output;
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat10 = float(u_xlat16_33) * u_xlat10;
    u_xlat16_33 = fma((-FGlobals._Metallic), half(0.959999979), half(0.959999979));
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat0.x = u_xlat0.x * 16.0;
    u_xlat16_5.xyz = _MainTex.sample(sampler_MainTex, input.TEXCOORD0.xy).xyz;
    u_xlat16_4.xyz = fma(FGlobals._Color.xyz, u_xlat16_5.xyz, half3(-0.0399999991, -0.0399999991, -0.0399999991));
    u_xlat5.xyz = float3(u_xlat16_5.xyz) * float3(FGlobals._Color.xyz);
    u_xlat16_4.xyz = fma(half3(FGlobals._Metallic), u_xlat16_4.xyz, half3(0.0399999991, 0.0399999991, 0.0399999991));
    u_xlat16_4.xyz = half3(u_xlat0.xxx * float3(u_xlat16_4.xyz));
    u_xlat16_18 = fma((-FGlobals._Metallic), half(0.959999979), half(0.959999979));
    u_xlat16_4.xyz = half3(fma(u_xlat5.xyz, float3(u_xlat16_18), float3(u_xlat16_4.xyz)));
    output.SV_Target0.xyz = u_xlat16_3.xyz * u_xlat16_4.xyz;
    output.SV_Target0.w = half(1.0);
    return output;
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_3.xyz = fma(FGlobals._Color.xyz, u_xlat16_4.xyz, half3(-0.0399999991, -0.0399999991, -0.0399999991));
    u_xlat4.xyz = float3(u_xlat16_4.xyz) * float3(FGlobals._Color.xyz);
    u_xlat16_3.xyz = fma(half3(FGlobals._Metallic), u_xlat16_3.xyz, half3(0.0399999991, 0.0399999991, 0.0399999991));
    u_xlat16_3.xyz = half3(u_xlat0.xxx * float3(u_xlat16_3.xyz));
    u_xlat16_14 = fma((-FGlobals._Metallic), half(0.959999979), half(0.959999979));
...
Constant Buffer "FGlobals" (144 bytes) on slot 0 {
  Matrix4x4 unity_WorldToLight at 80
  Vector4 _LightPositionRange at 0
  Vector4 _LightProjectionParams at 16
  Vector4 _LightShadowData at 32
  VectorHalf4 _LightColor0 at 48
  VectorHalf4 _Color at 56
  ScalarHalf _Metallic at 64
  Float _Glossiness at 68
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat16_3.xyz = fma(half3(FGlobals._Metallic), u_xlat16_3.xyz, half3(0.0399999991, 0.0399999991, 0.0399999991));
    u_xlat16_3.xyz = half3(u_xlat0.xxx * float3(u_xlat16_3.xyz));
    u_xlat16_13 = fma((-FGlobals._Metallic), half(0.959999979), half(0.959999979));
